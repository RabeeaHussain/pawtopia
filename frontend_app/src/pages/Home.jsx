  ...
  if (loading) {
    return (
      <div
        ...
        style={{ backgroundColor: COLOR_CREAM, color: COLOR_GOLD }}
      >
    ...
    >
      ...
      <div className="pt-20">
        <section className="text-center py-20 px-4">
          ...
          <p
            className="text-xl max-w-3xl mx-auto opacity-90 font-light mb-12"
            style={{ color: COLOR_NAV_TEXT }}
          >
            Adopt real pets, care for virtual companions, and shop for all your
            furry friends in one happy place.
          </p>

          <div className="flex justify-center mt-8">
            <div
              className="w-4/5 md:w-1/3 h-px relative"
        ...
        <section
          className="max-w-7xl mx-auto py-16 px-6 md:px-8 my-16 rounded-3xl shadow-2xl"
          style={{ backgroundColor: "white" }}
        >
          <div
            className="flex justify-between items-center mb-8 pb-4 px-6 rounded-t-3xl"
            style={{ backgroundColor: COLOR_NAV_BG }}
          >
            <h2
              className="text-4xl tracking-tight font-serif italic py-4"
              style={{ color: COLOR_NAV_TEXT }}
            >
            ...
            <Link
              to="/virtual"
              className="flex items-center gap-1 text-lg font-medium hover:text-white transition"
              style={{ color: COLOR_NAV_TEXT }}
            >
              Explore
              <ArrowRight size={18} />
          ...
          {virtualPets.length === 0 ? (
            <p
              className="text-center text-xl py-8 opacity-90"
              style={{ color: COLOR_NAV_TEXT }}
            >
        ...
        <section className="max-w-7xl mx-auto py-16 px-6 md:px-8">
          <div
            className="flex justify-between items-center mb-8 pb-3 px-6 rounded-t-xl"
            style={{ backgroundColor: COLOR_NAV_BG }}
          >
            <h2
              className="text-4xl tracking-tight font-serif italic py-4"
          ...
          {realPets.length === 0 ? (
            <p
              className="text-center text-xl py-8 opacity-80"
              style={{ color: COLOR_NAV_TEXT }}
            >
              ...
              {realPets.map((pet) => (
                ...
                >
                  <div className="p-6" style={{ color: COLOR_NAV_TEXT }}>
                    ...
                    <p className="text-sm text-gray-500 mt-1 italic font-light">
                      {pet.species}
                    </p>
        ...
        <section className="max-w-7xl mx-auto py-16 px-6 md:px-8 text-center pb-32">
          ...
          <p
            ...
            style={{ color: COLOR_NAV_TEXT }}
          >
            Visit our shop for high-quality toys, nourishing food, and essential
            accessories your pets will love.
          </p>
          <Link
            to="/shop"
